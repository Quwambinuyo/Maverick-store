  ...
  return (
    <section className="px-6 py-4 pb-16">
      ...
      <div className="flex flex-col md:flex-row md:justify-between gap-3 mb-4">
        {/* Search Section  */}
        <div className="order-1 md:order-2 flex justify-end w-full md:w-auto">
          <div className="flex items-center gap-3 w-full md:w-auto">
            {showSearch && (
              <input
                type="search"
                placeholder="Search order by Id"
                className="border border-primary-color focus:outline-none px-2 py-1 rounded-lg w-full md:w-[180px]"
                value={searchText}
            ...
            <button
              ...
              className="bg-primary-color p-2 rounded-lg flex items-center justify-center"
            >
        ...
        {/* Filters Section */}
        <div className="order-2 md:order-1 flex overflow-x-auto scrollbar-hide gap-3">
