...
const Register = () => {
  ...
  return (
    <section className="w-screen h-screen flex flex-col md:flex-row bg-white">
      {/* Left Side */}
      <div className="relative w-full md:w-1/2 flex flex-col items-start justify-center gap-6 border-b md:border-b-0 md:border-r border-gray-100 px-10 pt-6 md:pt-0">
        <a
          href="/"
          ...
          <div className="w-full max-w-lg mx-auto">
            ...
            >
              ...
              <p className="mb-6 text-left text-gray-800 font-semibold">
                Set up your account now to master your money speak volumes of
                your look.
              </p>
