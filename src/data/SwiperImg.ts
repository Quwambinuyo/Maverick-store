export const SwiperImg = [
  {
    ...
    paragraph:
      "Make a statement without saying a word. From bold patterns to tailored fits, our collections are crafted to highlight your unique style and elevate your wardrobe.",
  },
  {
    id: 2,
    image:
  ...
  },
  {
    id: 3,
    image:
      "https://plus.unsplash.com/premium_photo-1664297943340-e7fcb94726bb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8amVyc2V5fGVufDB8fDB8fHww",
    description: "comfort meets class",
    paragraph:
      "Who says you can’t have both? Our latest drop blends soft, breathable fabrics with sleek designs — made for all-day wear without compromising on style.",
  },
  {
    id: 4,
    image:
